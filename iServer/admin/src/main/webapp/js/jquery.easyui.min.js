...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"此为必填项!",invalidMessage:null,rules:{email:{validator:function(_2fa){
...
},message:"请输入有效的邮件地址."},url:{validator:function(_2fb){
