...
CREATE TABLE `t_SiteUser` (
  ...
  `password` VARCHAR(32) NOT NULL COMMENT '密码',
  `authorities` VARCHAR(2) NOT NULL COMMENT '权限类型：1 超级管理员 2 企业管理员 3 部门管理员',
  `enabled` VARCHAR(1) NOT NULL COMMENT '使能：1 启用 2 禁用',
  `ecName` VARCHAR(32) COMMENT '归属企业名称，超级管理员为空',
  `reserve0` VARCHAR(3200) COMMENT '预留属性0',
  `reserve1` VARCHAR(1000) COMMENT '预留属性1',
  `reserve2` VARCHAR(1000) COMMENT '预留属性2',
  `reserve3` VARCHAR(1000) COMMENT '预留属性3',
  `reserve4` VARCHAR(1000) COMMENT '预留属性4',
  `reserve5` VARCHAR(32) COMMENT '预留属性5',
  `reserve6` VARCHAR(32) COMMENT '预留属性6',
  `reserve7` VARCHAR(32) COMMENT '预留属性7',
  `reserve8` VARCHAR(32) COMMENT '预留属性8',
  `reserve9` VARCHAR(32) COMMENT '预留属性9',
